...
My goal for this deliverable was to combine a user interface with a database 
2. Did you meet this goal? If not, why?
I did indeed meet this goal 
...
Give myself extra time for the next deliverable and also finish the other part of the program with the personal pages of each user.
